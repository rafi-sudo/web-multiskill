...
<div class="swiper mySwiper" style="width: 100%; max-width: 600px; margin:auto;">
  <div class="swiper-wrapper">
    <div class="swiper-slide"><img src="{{ 'assets/images/first-driving-lesson-768x512.jpg' | prepend: site.baseurl }}" alt="Mengemudi" style="width:100%;"></div>
    <div class="swiper-slide"><img src="{{ 'assets/images/nervous-driving-lessonn.jpg' | prepend: site.baseurl }}" alt="Mengemudi" style="width:100%;"></div>
    <div class="swiper-slide"><img src="{{ 'assets/images/Teen-In-Person-Driving-Lessons-1.webp' | prepend: site.baseurl }}" alt="Mengemudi" style="width:100%;"></div>
  </div>
  <!-- Navigasi panah -->
